...
const LeaderBoard: FC = () => {
	...
	useEffect(() => {
		if (developersData) {
			const getDevelopersTotalScore = getDeveloperDetails(developersData);
	...
	}, [developersData, sortedData, sortCritera]);

	// useEffect(() => {}, [sortCritera, sortedData]);
				...
				<StyledTable>
					<TableHead>
						<TableRow>
							...
							<TableHeaderCell
								onClick={() => handleSortChange("totalfOpenPrs")}
							>
								<SecondaryButton>PR Open</SecondaryButton>
							</TableHeaderCell>
							<TableHeaderCell
								onClick={() => handleSortChange("totalMergedPrs")}
							>
							...
							<TableHeaderCell
								onClick={() => handleSortChange("totalCommnets")}
							>
